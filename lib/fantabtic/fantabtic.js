...
app.config(function ($compileProvider, $qProvider) {
  ...
  // Fix possibly unhandled rejection
...
app.controller("MainController", function (TopSite, App, Storage, $scope, $rootScope, $http, $timeout, $interval) {
  ...
  // Update time and date every 10 seconds
  $interval(function () {
...
app.controller("MenuController", function (Storage, $scope, $rootScope) {
  ...
  function constructor() {
     ...
     * @type {string}
     */
    $scope.rateLink = "https://chrome.google.com/webstore/detail/fantabtic-new-tab/oegifjmgljecjkpjjpdapnmpjioodadp/reviews";
